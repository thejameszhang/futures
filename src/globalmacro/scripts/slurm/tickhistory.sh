...
#SBATCH --output=tickhistory-%j.out       # File for standard output
#SBATCH --error=tickhistory-%j.err        # File for standard error
#SBATCH --time=2:00:00                    # Maximum runtime in HH:MM:SS
