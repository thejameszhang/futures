...
def main():
    ...
    os.makedirs(DATASETS_ROOT / f"tier{args.tier}" / "sync", exist_ok=True)
    returns_wide.write_csv(DATASETS_ROOT / f"tier{args.tier}" / "sync" / f"{ASSET_CLASS.name.lower()}_daily_returns.csv")
